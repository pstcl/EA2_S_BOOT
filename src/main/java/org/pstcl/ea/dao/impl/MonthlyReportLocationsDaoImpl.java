...
public class MonthlyReportLocationsDaoImpl implements MontlyReportLocationsDao {

	static final Logger logger = LoggerFactory.getLogger(MonthlyReportLocationsDaoImpl.class);
